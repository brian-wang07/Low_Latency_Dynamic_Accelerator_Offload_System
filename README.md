userspace system for dynamic accelerator offload under market microbursts
...
Create mvp using shared memory, later implement vfio-ioctl pcie emulation -> (march 25: maybe connect De1-SoC FPGA? overhead is quite big though...)
